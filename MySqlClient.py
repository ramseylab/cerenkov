...
__db_url_config = dict(
    local_hg19=dict(
        #I need to find the driver name
        ...
        username='bud',
        password='earth',
        #UCSC "modified" annoted genome - it is always hw[number].
        #hg19 = UCSC-annotated version of human genome assembly GRCh37
        database='hg19',
        query={'charset': 'utf8'}
    ),

    #I can try the remote hg19.
    #Try server my sql status and see if the mysql daemon is running
    #sudo service mysql status
    #My SQL needs to be told that it needs a remote
    remote_hg19=dict(
        drivername='mysql+pymysql',
    ...
    #These are for the known ground truth SNPs.
    #For feature extraction, we do not need this.
    local_hgmd=dict(
        drivername='mysql+pymysql',
        # host='localhost',
        host='10.214.70.90',
