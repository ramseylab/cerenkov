...
if __name__ == "__main__":
    ...
    # ----- 0. READ RSID -----
    rsid_fn = args.r_src
    # rsid_fn = open("chr01-rsids.txt", "r")
    ...
    print("Bed file name: ", len(bed_file.name))
    ...
    #SOMETHING WRONG WITH THE BED FILE CREATION AND AUG_INPUT
    #Works
    ...
    # df_lst = [snp_df, tf_df, mst_dhs_df, uni_dhs_df, phastcons_df, tss_dist_df, eqtl_pval_df, gerp_df, avg_gerp_df,
    #           g_seg_df, eigen_df, nki_lad_df, fsu_rc_df, uw_rc_df, sanger_tfbs_df, vh_df, gwava_df]
   
    df_lst = [snp_df, tf_df, mst_dhs_df, uni_dhs_df, phastcons_df, tss_dist_df, eqtl_pval_df, avg_gerp_df, g_seg_df, eigen_df, nki_lad_df,
    fsu_rc_df, uw_rc_df, vh_df, gwava_df, gerp_df, dsgc_df, sanger_tfbs_df, aug_df]
    ...
    #This is taking the column data, merging, then taking the merged column and merging it again.
